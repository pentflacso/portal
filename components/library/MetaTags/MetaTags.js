...
export default function MetaTags({ pageTitle, shareTitle, keywords, description,  url ,img }){     
    ...
    return(
        <>
            <Head>
                ...
                <meta property="og:url" content={url ? url : `https://pent.flacso.org.ar${router.asPath}`}/>
