...
export default function Index() {
    ...
    return ( <
        ...
        <
        MetaTags pageTitle = 'Certificación - Enseñanza y Aprendizaje con Inteligencia Artificial — FLACSO | PENT'
        ...
        course = "Certificación - Enseñar y Aprender con Inteligencia Artificial"
        announcementOverlapping = { false }
        />       <
        NavBarIa refNavBrand = { navBarBrand }
        ...
        CvSelector persons = {
            [{
                ...
                },
                {
                    ...
                    "nombre": "Adriana Mazza",
                    "bio": "Es Maestranda en Tecnología Educativa (UBA), especialista en Educación y Tecnología (FLACSO) y licenciada en Psicología (UBA).",
                    "nid": "8",
                    "alias": "/equipo/adriana-mazza",
                    "img": {
                        "alt": "Foto Adriana Mazza",
                        "url": "https://redaccion.pent.org.ar/sites/default/files/2023-06/adriana_mazza_profile.webp"
                    }
                }
            ]
        }
